...
@section('title', 'Donasi Harian - Manajemen Masjid')

@section('content')
<div class="row">
    <div class="col-md-12 mb-4">
        <h2>Donasi Harian Masjid</h2>
        <p>Berkontribusi dalam kegiatan harian masjid merupakan amal jariyah yang bermanfaat bagi jamaah.</p>
    </div>
</div>
    ...
    <div class="col-lg-8 mx-auto">
        <div class="card shadow">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0">Form Donasi Harian</h5>
            </div>
            <div class="card-body">
                @if(session('success'))
                ...
                <form action="{{ route('donasi.harian.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
    ...
    <div class="col-lg-4 mt-4 mt-lg-0">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <p class="mt-3 small text-muted">Mohon tambahkan kode "DH" di berita transfer untuk donasi harian.</p>
            </div>
        </div>
