...
@section('title', 'Donasi Pembangunan - Manajemen Masjid')

@section('content')
<div class="row">
    <div class="col-md-12 mb-4">
        <h2>Donasi Pembangunan Masjid</h2>
        <p>Berkontribusi dalam pembangunan masjid merupakan amal jariyah yang pahalanya akan terus mengalir.</p>
    </div>
</div>
    ...
    <div class="col-lg-8 mx-auto">
        <div class="card shadow">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0">Form Donasi Pembangunan</h5>
            </div>
            <div class="card-body">
                @if(session('success'))
                ...
                <form action="{{ route('donasi.pembangunan.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
    ...
    <div class="col-lg-4 mt-4 mt-lg-0">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <p class="mt-3 small text-muted">Mohon tambahkan kode "DP" di berita transfer untuk donasi pembangunan.</p>
            </div>
        </div>
